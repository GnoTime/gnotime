...
void gtt_gsettings_get_maybe_str(GSettings *settings, const gchar *key, gchar **value);
...
void gtt_gsettings_set_maybe_str(GSettings *settings, const gchar *key, const gchar *value);
