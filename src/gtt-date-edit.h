...
#define GNOME_DATE_EDIT(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GNOME_TYPE_DATE_EDIT, GnomeDateEdit))
#define GNOME_DATE_EDIT_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), GNOME_TYPE_DATE_EDIT, GnomeDateEditClass))
...
#define GNOME_DATE_EDIT_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), GNOME_TYPE_DATE_EDIT, GnomeDateEditClass))
