...
#define GTT_PROJECTS_TREE_CLASS(klass)                                        \
  (G_TYPE_CHECK_CLASS_CAST ((klass), GTT_TYPE_PROJECTS_TREE,                  \
                            GttProjectsTreeClass))
#define GTT_IS_PROJECTS_TREE(obj)                                             \
  (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GTT_TYPE_PROJECTS_TREE))
...
#define GTT_PROJECTS_TREE_GET_CLASS(obj)                                      \
  (G_TYPE_INSTANCE_GET_CLASS ((obj), GTT_TYPE_PROJECTS_TREE,                  \
                              GttProjectsTreeClass))
 ...
 * give project list.
 */
void gtt_projects_tree_populate (GttProjectsTree *ptree, GList *plist,
                                 gboolean recursive);

void gtt_projects_tree_set_visible_columns (GttProjectsTree *project_tree,
                                            GList *columns);

void gtt_projects_tree_update_project_data (GttProjectsTree *gpt,
                                            GttProject *prj);
...
void gtt_projects_tree_set_show_seconds (GttProjectsTree *gpt,
                                         gboolean show_seconds);
gboolean gtt_projects_tree_get_show_seconds (GttProjectsTree *gpt);
void gtt_projects_tree_set_highlight_active (GttProjectsTree *gpt,
...
void gtt_projects_tree_append_project (GttProjectsTree *gpt, GttProject *prj,
                                       GttProject *sibling);
void gtt_projects_tree_insert_project_before (GttProjectsTree *gpt,
                                              GttProject *prj,
                                              GttProject *sibling);
gchar *gtt_projects_tree_get_expander_state (GttProjectsTree *gpt);
void gtt_projects_tree_set_expander_state (GttProjectsTree *gpt,
                                           gchar *states);

gint gtt_projects_tree_get_col_width (GttProjectsTree *gpt, int col);
void gtt_projects_tree_set_col_width (GttProjectsTree *gpt, int col,
                                      int width);

GtkTreeViewColumn *gtt_projects_tree_get_column_by_name (GttProjectsTree *gpt,
                                                         gchar *column_name);
