...
static void gtt_entry_set_history_id(GttEntry *gentry, const gchar *history_id);

static void gtt_entry_prepend_history(GttEntry *gentry, gboolean save, const gchar *text);
